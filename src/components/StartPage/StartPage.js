...
import '../shared/PageLayout/PageLayout.css';
...
function StartPage() {
	return (
		<div className="PageLayout StartPage">
			...
			<div className="left_column_btn">сайты - меню - вход - новости</div>
				...
				<div className="menu" width="100%">
					<div style={{ width: '160px', margin: 'auto' }}>
						<center>
							...
							>
								<img
									src="https://ege.sdamgia.ru/adv/agm.gif"
					...
					<a href="/" title="Пройти тестирование, проверить себя">
